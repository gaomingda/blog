...
<div>
        ...
        <nav>
            ...
            <div class="my-info" onmouseover="hiddeewm()" onmouseout="hiddeewm()">
                ...
                <div id="hiddenewm" hidden="true" >
                    <img src="/img/me.jpg" width="150px" height="150px" >
                    <p></p>
                </div>
            </div>
        </nav>
    ...
    <div id="container">
        <article class="article">
            <p>
                <br><br><br><br>
            <h3>一个幻想着有一天能到动物园去养鹿的程序员。</h3>
            <h3></h3>
            <h3>或许我们可以成为朋友？</h3>
            <div class="item">
                <img src="img/me.jpg" width="100px" height="100px" >
            </div>
            <br><br>
            <h3>邮箱:<a href="mailto:gaomingda@hotmail.com">gaomingda@hotmail.com</a></h3>
            <br><br><br><br>
            </p>
        </article>
    </div>
